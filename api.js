...
function addPref(event){
	...
	fetch("add_preferiti.php?titolo="+target.parentNode.firstChild.dataset.textTitolo+"&img="+target.parentNode.nextSibling.src+"&url="+target.parentNode.nextSibling.nextSibling.href).then(onResponse).then(addPrefJson);
}
